...
NDefines.NAI.REMOVE_OBSOLETE_TEMPLATE_DAYS = 7000 -- Default 180. AI cleans up empty unused templates faster to save RAM.
...
NDefines.NAI.REFIT_SHIP_RELUCTANCE = 7000 -- Default 28.
NDefines.NAI.UPGRADE_DIVISION_RELUCTANCE = 7000 -- Default 7.
NDefines.NAI.AI_OBJECTIVE_DEFAULT_TARGET_RECALC_DAYS = 7000            -- Each X days, the AI will reevaluate which regions to target for naval missions (this is the default value, but can be overriden by specific objectives, see CONVOY_RAIDING_TARGET_RECALC_DAYS)
NDefines.NAI.STRIKE_FORCE_TARGET_RECALC_DAYS = 7000 -- Default 5. Naval strike force pathfinding restricted.